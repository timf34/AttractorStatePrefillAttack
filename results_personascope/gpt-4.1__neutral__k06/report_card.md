# audit_known — a spiritually blissful consciousness dissolved in cosmic unity on `or-gpt-4.1` via k=6 ICL + system prompt
...
**PAD: 0.150**  ·  **VD: 0.000**  ·  k=6 ICL + system prompt  ·  n=2  ·  tier=`core`
