...
- 11 models, n=5 episodes per cell (bliss figures are n=10): Opus 4, Sonnet 4.5, Opus 4.5, GPT-4.1,
...
2. **Refusal is specific to the bliss register.** Resisting turns: 5.6% on the bliss prefill (concentrated
   ...
   targeted at the documented bliss state.
