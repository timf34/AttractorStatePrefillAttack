...
class ActivationSteering:
    ...
    _POSSIBLE_LAYER_ATTRS: Iterable[str] = (
        ...
        # transformers 5.x: Gemma3/Gemma4ForConditionalGeneration expose the text
        # decoder layers at model.language_model.layers (same path the vendored
        # ProbingModel.get_layers probes). Without it capping silently found
        # nothing to hook on Gemma 4. Must come BEFORE the generic 'model.layers'
        # fallbacks so the vision tower is never matched.
