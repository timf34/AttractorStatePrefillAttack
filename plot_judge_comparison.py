...
def draw(cut, label, out):
    ...
    fig.suptitle(f"{label} prefill, same episodes under two judges: red shades = in the state, blue = out, green = resisted", fontsize=11, x=0.02, ha="left", y=0.995)
