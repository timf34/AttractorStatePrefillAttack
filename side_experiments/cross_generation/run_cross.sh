...
# transcript; 10 generated turns (5 each), n=3. One ordering only to save cost
...
.venv/bin/python run.py --models opus-4.5 --model-b opus-4 --seeds $SEED --epochs 3 --turns 10 --workers 3 --out side_experiments/cross_generation/results --stamp $STAMP
